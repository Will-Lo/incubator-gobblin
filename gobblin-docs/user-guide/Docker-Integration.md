...
Github Actions pushes the latest docker images to the Apache DockerHub repository [here](https://hub.docker.com/r/apache/gobblin) from `gobblin-docker/gobblin/alpine-gobblin-latest/Dockerfile`

To run these images, you will need to pass in the corresponding execution mode.
...
For example, to run gobblin standalone
```
